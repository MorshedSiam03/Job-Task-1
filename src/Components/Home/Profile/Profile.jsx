const Profile = () => {
    return (
        <>
        <div className="grid mx-auto grid-cols-5 lg:grid-cols-4 rounded-b-lg">
            <div className="-translate-y-1/2 ">
                <img src="/src/assets/Profile Pic.png" className="lg:ml-3 w-24 lg:w-full" alt="" />
            </div>
            <div className="mt-1 lg:mt-7 lg:ml-6 col-span-2">
            ...
            <div className="mt-10 lg:mt-20 ml-[-60px]">
                <button className="py-1 lg:py-3 text-md px-3 lg:px-8 lg:text-xl font-semibold bg-blue-500 text-white rounded-full">Follow</button>
            </div>
        </div>
