    ...
    return (
        ...
        <div className="grid mx-auto grid-cols-7 lg:grid-cols-4 rounded-b-lg">
            ...
            <div className="mt-8 ml-[-20px] lg:ml-6 lg:mt-20 ">
                <button className="py-1 lg:py-2 text-md px-3 lg:px-8 lg:text-xl hover:bg-transparent  hover:text-blue-700 hover:border-2 hover:border-blue-800 font-semibold bg-blue-700 text-white rounded-full">Follow</button>
            </div>
        </div>
